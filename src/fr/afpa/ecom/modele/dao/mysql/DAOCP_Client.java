...
class DAOCP_Client extends DAOCP<Client> {
    ...
    public ArrayList<Client> getAll() throws DaoException {
        ...
        try {
            ...
            while ( rs.next() ) {
                al.add( new Client( rs.getInt( 1 ), ServiceDAO.getDateTime( rs.getDate( 2 ), rs.getTime( 2 ) ),
                        rs.getString( 3 ), rs.getString( 4 ),
                        ServiceDAO.RemplaceStringNull( rs.getString( 5 ), "i" ).charAt( 0 ), rs.getString( 6 ),
                        rs.getString( 7 ), ServiceDAO.getDateTime( rs.getDate( 8 ), rs.getTime( 8 ) ),
    ...
    public Client getById( int id ) throws DaoException {
        ...
        try {
            ...
            if ( rs.first() ) {
                c = new Client( rs.getInt( 1 ), ServiceDAO.getDateTime( rs.getDate( 2 ), rs.getTime( 2 ) ),
                        rs.getString( 3 ), rs.getString( 4 ),
                        ServiceDAO.RemplaceStringNull( rs.getString( 5 ), "i" ).charAt( 0 ), rs.getString( 6 ),
                        rs.getString( 7 ), ServiceDAO.getDateTime( rs.getDate( 8 ), rs.getTime( 8 ) ),
                        rs.getString( 9 ), rs.getString( 10 ),
