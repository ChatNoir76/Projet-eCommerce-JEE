		...
		<legend>Formulaire d'inscription</legend>
			...
			<div class="form-row">
			    ...
			    <div class="form-group col-md-2">
			      ...
			      <select id="inputSexe" name="inputSexe" class="form-control">
			  ...
			  <div class="form-row">
			    <div class="form-group col-md-2">
			      ...
			      <input type="text" class="form-control" id="inputTel" name="inputTel" placeholder="+033612345678">
			    </div>
			    <div class="form-group col-md-2">
			      <label for="inputNaissance">Date de naissance</label>
			      <input type="date" class="form-control" id="inputNaissance" name="inputNaissance" >
			    </div>
			  </div>
			  <div class="form-group">
			    <label for="inputAddress"><span class="text-danger">*</span>Addresse</label>
			    <input type="text" class="form-control" id="inputAddress" name="inputAddress" placeholder="numéro et nom de la rue" required />
			  </div>
			  <div class="form-row">
			    <div class="form-group col-md-6">
			      <label for="inputCity"><span class="text-danger">*</span>Ville</label>
			      <input type="text" class="form-control" id="inputCity" name="inputCity" placeholder="nom de la ville" required />
			    </div>
			    ...
			    <div class="form-group col-md-3">
			      ...
			      <input type="text" class="form-control" id="inputPays" name="inputPays" placeholder="France" readonly required />
			    </div>
			  </div>
			  <div class="form-group">
